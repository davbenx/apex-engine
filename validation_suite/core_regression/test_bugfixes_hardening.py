...
def test_apex_full_historical_trades_integrity(historical_trades_json_path, historical_trades_csv_path):
    ...
    # 1. Almeno 1100 trade storici registrati (1987-2026), comprendenti macro, point-in-time,
    # crypto venture e l'intero tracking live 2024-2026.
    assert len(trades) >= 1100, f"Attesi almeno 1100 trade, trovati {len(trades)}"

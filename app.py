...
def get_class_svg(classe, size=15, color="currentColor"):
    ...
    if classe == "Oro":
        return f'<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="{style}"><path d="M8 4h8l2 4H6z"></path><path d="M6 8h12l-1.5 4h-9z"></path><path d="M3 13h7l1.5 4h-9z"></path><path d="M2.5 17h9l-1.5 4h-6z"></path><path d="M14 13h7l1.5 4h-9z"></path><path d="M13.5 17h9l-1.5 4h-6z"></path></svg>'

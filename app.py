...
def get_class_svg(classe, size=15, color="currentColor"):
    ...
    if classe == "Oro":
        return f'<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" style="{style}"><polygon points="8,3 16,3 18,7 6,7" /><polygon points="6,7 18,7 16.5,11 7.5,11" /><polygon points="3,12 10.5,12 11.5,16 2,16" /><polygon points="2,16 11.5,16 10.5,20 3,20" /><polygon points="13.5,12 21,12 22,16 12.5,16" /><polygon points="12.5,16 22,16 21,20 13.5,20" /></svg>'

...
V2_VOL_TARGET = 0.22  # alzato da 0.13 — vedi APEX_V2_SPEC.md §8.25/§10.13 (Percorso B):
                      ...
                      # motore pensato per generare alpha. Ripristinato dopo un ripristino
                      # non richiesto a 0.13 fatto da un altro strumento (Gemini Antigravity)
                      # su una pipeline dati scollegata dal codice reale (istituzioni
                      # sbagliate: Invesco/CoinShares invece di iShares/WisdomTree) e senza
